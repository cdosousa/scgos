 ...
 */
public class PesquisarEspecialidade extends JDialog{
    ...
    //Contrutor padrão
    public PesquisarEspecialidade(Frame parent, boolean modal, String chamador){
        super(parent, modal);
    ...
    public void initComponentes(){
        ...
        tabelaPes = new JTable(espDAO);
                        
        //Definindo o tamanho da Janela
        AjustarTamanhoTabela();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setModal(true);
        setTitle("Pesquisar Especialidades");
    ...
    public void buscarTodos(){
        try{
            ...
            espDAO.setQuery("SELECT CD_ESPECIALIDADE AS Código,"
                    + "NOME_Especialidade AS Nome,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificao"
                    + ",SITUACAO AS Sit"
                    + " FROM GSMESPECIALIDADES");
            }
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_ESPECIALIDADE AS Código,"
                    + "NOME_ESPECIALIDADE AS Nome,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificao"
                    + ",SITUACAO AS Sit"
                    + " FROM GSMESPECIALIDADES WHERE NOME_ESPECIALIDADE LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            espDAO.setQuery(query);
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarEspecialidade dialog = new PesquisarEspecialidade(new JFrame(),true,chamador);
