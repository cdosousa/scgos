...
import br.com.gsm.controle.CTarefas;
 ...
 */
public class ManterTarefas extends javax.swing.JFrame {

    private Tarefas regCorr;
    private List< Tarefas> resultado;
    private CTarefas pta;
    private Tarefas sqlta;
    private int numReg;
    private int idxCorr;
    private String sql;
    private String oper;
     ...
     */
    public ManterTarefas(SessaoUsuario su) {
        this.su = su;
        oper = "N";
        initComponents();
    ...
    public void upRegistros() {
        ...
        pta.mostrarPesquisa(sqlta, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForTarefa.setText(sqlta.getCdTarefa().trim());
        jTexNomeTarefa.setText(sqlta.getNomeTarefa().trim());
        jTexCadastradoPor.setText(sqlta.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlta.getDataCadastro())));
        if (sqlta.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlta.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlta.getSituacao()));
    ...
    public void liberarCampos() {
        jTexNomeTarefa.setEditable(true);
    ...
    private void initComponents() {
        ...
        jForTarefa = new javax.swing.JFormattedTextField();
        ...
        jLabReg.setText("\\");
            ...
            jForTarefa.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));

            jTexNomeTarefa.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeTarefaActionPerformed(evt);
                }
            });
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanSecundarioLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jTexNomeTarefa, javax.swing.GroupLayout.PREFERRED_SIZE, 427, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jForTarefa, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabSituacao)
                        .addComponent(jForTarefa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jTexNomeTarefaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeTarefaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeTarefaActionPerformed

    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForTarefa.getText().isEmpty() || jTexNomeTarefa.getText().isEmpty() || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            JOptionPane.showMessageDialog(null, "Os campos Codigo, Descrição e Situação precisam ser preenchidos corretamente!");
        } else {
            DataSistema dat = new DataSistema();
            Tarefas ta = new Tarefas();
            String data = null;
            ta.setCdTarefa(jForTarefa.getText().toUpperCase());
            ta.setNomeTarefa(jTexNomeTarefa.getText().toUpperCase());
            ta.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            ta.setDataCadastro(data);
            ta.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            TarefasDAO tadao = null;
            sql = "SELECT * FROM GSMTAREFAS WHERE CD_TAREFA = "
                    + "'"
                    + jForTarefa.getText().toUpperCase().trim()
                    + "'";
            try {
                ...
                Logger.getLogger(ManterTarefas.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeTarefa.getText().isEmpty()) {
            sql = "SELECT * FROM GSMTAREFAS";
        } else {
            sql = "SELECT * FROM GSMTAREFAS WHERE NOME_TAREFA LIKE '%" + jTexNomeTarefa.getText().trim() + "%'";
        }
        bloquearCampos();
        pesquisar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterTarefas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterTarefas(su).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField jForTarefa;
