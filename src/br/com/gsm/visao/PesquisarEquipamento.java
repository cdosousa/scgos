 ...
 */
public class PesquisarEquipamento extends JDialog{
    //Variáveis de instância privadas
    private EquipamentosDAO eqpDAO;
    ...
    //Contrutor padrão
    public PesquisarEquipamento(Frame parent, boolean modal, String chamador){
        super(parent, modal);
    ...
    public void initComponentes(){
        ...
        tabelaPes = new JTable(eqpDAO);
                        
        //Definindo o tamanho da Janela
        AjustarTamanhoTabela();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setModal(true);
        setTitle("Pesquisar Equipamentos");
    ...
    public void buscarTodos(){
        try{
            ...
            eqpDAO.setQuery("SELECT CD_EQUIPAMENTO AS Código,"
                    + "NOME_EQUIPAMENTO AS Nome,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificao"
                    + ",SITUACAO AS Sit"
                    + " FROM GSMEQUIPAMENTOS");
            }
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_EQUIPAMENTO AS Código,"
                    + "NOME_EQUIPAMENTO AS Nome,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificao"
                    + ",SITUACAO AS Sit"
                    + " FROM GSMEQUIPAMENTOS WHERE NOME_EQUIPAMENTO LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            eqpDAO.setQuery(query);
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarEquipamento dialog = new PesquisarEquipamento(new JFrame(),true,chamador);
