 ...
 */
public class PesquisarTarefas extends JDialog{
    //Variáveis de instância privadas
    private TarefasDAO taDAO;
    ...
    //Contrutor padrão
    public PesquisarTarefas(Frame parent, boolean modal, String chamador){
        super(parent, modal);
    ...
    public void buscarTodos(){
        try{
            taDAO = new TarefasDAO();
            taDAO.setQuery("SELECT CD_TAREFA AS Código,"
                    + "NOME_TAREFA AS Nome,"
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_TAREFA AS Código,"
                    + "NOME_TAREFA AS Nome,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificao,"
                    + "SITUACAO AS Sit"
                    + " FROM GSMTAREFAS WHERE NOME_TAREFA LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            taDAO.setQuery(query);
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarTarefas dialog = new PesquisarTarefas(new JFrame(),true,chamador);
