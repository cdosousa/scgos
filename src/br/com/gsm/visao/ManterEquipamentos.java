 ...
 * @author cristiano
 */
public class ManterEquipamentos extends javax.swing.JFrame {
     ...
     */
    public ManterEquipamentos(SessaoUsuario su) {
        this.su = su;
        oper = "N";
        initComponents();
    ...
    public void upRegistros() {
        ...
        jTexCadastradoPor.setText(sqleqp.getUsuarioCadastro());
    ...
    public void novoRegistro(){
        ...
        liberarCampos();
        jForCodigoEquipamento.setEditable(true);
        jForCodigoEquipamento.requestFocus();
    }
    ...
    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        ...
        if (jForCodigoEquipamento.getText().isEmpty() || jTexNomeEquipamento.getText().isEmpty() || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            ...
            try {
                ...
                Logger.getLogger(ManterEquipamentos.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        // TODO add your handling code here:
        if (!jForCodigoEquipamento.getText().isEmpty()) {
            try {
                Equipamentos cc = new Equipamentos();
                cc.setCdEquipamento(jForCodigoEquipamento.getText().toUpperCase());
                EquipamentosDAO ccDAO = new EquipamentosDAO();
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterEquipamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterEquipamentos(su).setVisible(true);
            }
        });
    }
