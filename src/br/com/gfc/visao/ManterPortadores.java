...
/**
 *
 * @author Cristiano de Oliveira Sousa created on 07/11/2017
 */
public class ManterPortadores extends javax.swing.JFrame {

    private static Connection conexao;
    private Portadores regCorr;
    private List< Portadores> resultado;
    private CPortadores cpor;
    private Portadores modpor;
     ...
     */
    public ManterPortadores(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    private void pesquisar() {
        ...
        modpor = new Portadores();
        try {
            numReg = cpor.pesquisar(sql);
            idxCorr = +1;
    ...
    private void upRegistros() {
        ...
        cpor.mostrarPesquisa(modpor, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCdPortador.setText(modpor.getCdPortador());
        jTexNomePortador.setText(modpor.getNomePortador());
        jForConta.setText(modpor.getCdConta());
        jForContaDigito.setText(modpor.getCdContaDig());
        jForAgencia.setText(modpor.getCdAgencia());
        jForAgenciaDigito.setText(modpor.getCdAgenciaDig());
        jForCdBanco.setText(modpor.getCdBanco().trim());
        jTexNomeBanco.setText(modpor.getNomeBanco().trim());
        jForTxJuros.setText(String.valueOf(modpor.getTaxaJuros()));
        jForTxMulta.setText(String.valueOf(modpor.getTaxaMulta()));
        jForTxCorrecao.setText(String.valueOf(modpor.getTaxaCorrecao()));
        jForDiasLiquidacao.setText(String.valueOf(modpor.getDiasLiquidacao()));
        jForDiasCartorio.setText(String.valueOf(modpor.getDiasCartorio()));
        jTexCadastradoPor.setText(modpor.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(modpor.getDataCadastro())));
        if (modpor.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(modpor.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(String.valueOf(modpor.getSituacao())));
    ...
    private void liberarCampos() {
        jTexNomePortador.setEditable(true);
    ...
    private void novoRegistro() {
        ...
        jForCdPortador.requestFocus();
    }
    
    /**
     * Método para chamar os cadastros EDI do portador
     */
    private void cadastrosEdi(){
        new ManterPortadoresParamEDI(su, conexao, modpor).setVisible(rootPaneCheckingEnabled);
    }

    // metodo para dar zoon no campo UF
    private void zoomContas() {
        PesquisarContasBancarias zoom = new PesquisarContasBancarias(new JFrame(), true, "P", conexao);
        zoom.setVisible(true);
        jForCdBanco.setText(zoom.getCdBanco().trim());
    ...
    private void initComponents() {
        ...
        jButCadastrosEDI = new javax.swing.JButton();
        ...
        jLabReg.setText("\\");
                ...
                .addGroup(jPanInformacoesLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanInformacoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanInformacoesLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(jForTxCorrecao, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanInformacoesLayout.createSequentialGroup()
                            .addComponent(jLabDiasLiquidacao)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(jForDiasLiquidacao, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(24, 24, 24)
                            .addComponent(jLabDiasCartorio)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(jForDiasCartorio, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            );
            ...
            jForConta.addKeyListener(new java.awt.event.KeyAdapter() {
                public void keyPressed(java.awt.event.KeyEvent evt) {
                    jForContaKeyPressed(evt);
                }
            });
            ...
            jButCadastrosEDI.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
            jButCadastrosEDI.setText("Cadastros EDI");
            jButCadastrosEDI.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jButCadastrosEDIActionPerformed(evt);
                }
            });
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanSecundarioLayout.createSequentialGroup()
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jLabConta, javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(jLabPortador, javax.swing.GroupLayout.Alignment.TRAILING))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
    ...
    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCdPortador.getText().isEmpty() || jForConta.getText().isEmpty() || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            JOptionPane.showMessageDialog(null, "Os campos Portador, Conta e Situacao precisam ser preenchidos corretamente!");
        } else {
            DataSistema dat = new DataSistema();
            Portadores por = new Portadores();
            String data = null;
            por.setCdBanco(jForCdBanco.getText().trim());
            por.setCdConta(jForConta.getText());
            por.setCdPortador(jForCdPortador.getText());
            por.setNomePortador(jTexNomePortador.getText().trim().toUpperCase());
            try {
                por.setTaxaJuros(formato.parse(jForTxJuros.getText()).doubleValue());
                por.setTaxaMulta(formato.parse(jForTxMulta.getText()).doubleValue());
                por.setTaxaCorrecao(formato.parse(jForTxCorrecao.getText()).doubleValue());
            } catch (ParseException ex) {
                Logger.getLogger(ManterPortadores.class.getName()).log(Level.SEVERE, null, ex);
            }
            if (!jForDiasLiquidacao.getText().trim().isEmpty()) {
                por.setDiasLiquidacao(Integer.parseInt(jForDiasLiquidacao.getText()));
            }
            if (!jForDiasCartorio.getText().trim().isEmpty()) {
                por.setDiasCartorio(Integer.parseInt(jForDiasCartorio.getText()));
            }
            por.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            por.setDataCadastro(data);
            por.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            PortadoresDAO pordao = null;
            sql = "SELECT * FROM GFCPORTADOR WHERE CD_PORTADOR = '" + jForCdPortador.getText().trim()
                    + "'";
            try {
                pordao = new PortadoresDAO(conexao);
                if ("N".equals(oper)) {
                    pordao.adicionar(por);
                } else {
                    pordao.atualizar(por);
                }
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomePortador.getText().isEmpty()) {
            sql = "SELECT * FROM GFCPORTADOR";
        } else {
            sql = "SELECT * FROM GFCPORTADOR WHERE NOME_PORTADOR LIKE '" + jTexNomePortador.getText().trim() + "'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        ...
        if (!jForConta.getText().isEmpty()) {
            try {
                Portadores cc = new Portadores();
                cc.setCdPortador(jForCdPortador.getText());
                PortadoresDAO ccDAO = new PortadoresDAO(conexao);
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            } catch (SQLException ex) {
    ...
    private void jForContaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jForContaKeyPressed
        // TODO add your handling code here:
        vt = new VerificarTecla();
        if ("F5".equals(vt.VerificarTecla(evt).toUpperCase())) {
            zoomContas();
        }
    }//GEN-LAST:event_jForContaKeyPressed

    private void jButCadastrosEDIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButCadastrosEDIActionPerformed
        // TODO add your handling code here:
        cadastrosEdi();
    }//GEN-LAST:event_jButCadastrosEDIActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterPortadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterPortadores(su, conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton jButCadastrosEDI;
