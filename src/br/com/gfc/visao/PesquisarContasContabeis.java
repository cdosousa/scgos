 ...
 * Modelo de tabela para pesquisa de usuários
 */
public class PesquisarContasContabeis extends JDialog{
    //Variáveis de instância privadas
    private ContasContabeisDAO plDAO;
    ...
    //Contrutor padrão
    public PesquisarContasContabeis(Frame parent, boolean modal, String chamador){
        super(parent, modal);
    ...
    public void initComponentes(){
        ...
        tabelaPes = new JTable(plDAO);
                        
        //Definindo o tamanho da Janela
        AjustarTamanhoTabela();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setModal(true);
        setTitle("Pesquisar Contas Contábeis");
        setMaximumSize(new java.awt.Dimension(1150, 320));
        setMinimumSize(new java.awt.Dimension(1150, 320));
        setPreferredSize(new java.awt.Dimension(1150, 320));
        setSize(new java.awt.Dimension(1150, 320));
        ...
        jPanTab.setMaximumSize(new java.awt.Dimension(1070, 150));
        jPanTab.setMinimumSize(new java.awt.Dimension(1070, 150));
        jPanTab.setPreferredSize(new java.awt.Dimension(1070, 150));
        ...
        jPanTabLayout.setHorizontalGroup(
                jPanTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanTabLayout.createSequentialGroup()
                            .addContainerGap()
                            .addComponent(jScrPane, javax.swing.GroupLayout.PREFERRED_SIZE, 1080, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanTab, javax.swing.GroupLayout.PREFERRED_SIZE, 1107, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
    ...
    public void buscarTodos(){
        try{
            ...
            plDAO.setQuery("SELECT CD_CONTA AS Conta,"
                    + "NOME_CONTA AS Nome,"
                    + "TIPO_CONTA AS Tipo,"
                    + "PATRIMONIAL AS Patrimonio,"
                    + "GRANDE_MOVIMENTACAO as Grande_Mov,"
                    + "ESTABELECIMENTO AS Estabelecimento,"
                    + "REDUZIDO AS Reduzido,"
                    + "CENTRO_RESULTADO AS Centro_Resul,"
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_CONTA AS Conta,"
                    + "NOME_CONTA AS Nome,"
                    + "TIPO_CONTA AS Tipo,"
                    + "PATRIMONIAL AS Patrimonio,"
                    + "GRANDE_MOVIMENTACAO as Grande_Mov,"
                    ...
                    + "DATA_MODIFICACAO AS Modificao,"
                    + "SITUACAO AS Sit"
                    + " FROM GFCPLANOCONTA WHERE NOME_CONTA LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            plDAO.setQuery(query);
    ...
    public void AjustarTamanhoTabela(){
        tabelaPes.getColumnModel().getColumn(0).setMinWidth(150);
        tabelaPes.getColumnModel().getColumn(0).setMaxWidth(150);
        tabelaPes.getColumnModel().getColumn(1).setMinWidth(300);
        tabelaPes.getColumnModel().getColumn(1).setMaxWidth(300);
        tabelaPes.getColumnModel().getColumn(2).setMinWidth(35);
        tabelaPes.getColumnModel().getColumn(2).setMaxWidth(35);
        tabelaPes.getColumnModel().getColumn(3).setMinWidth(70);
        tabelaPes.getColumnModel().getColumn(3).setMaxWidth(70);
        tabelaPes.getColumnModel().getColumn(4).setMinWidth(80);
        tabelaPes.getColumnModel().getColumn(4).setMaxWidth(80);
        tabelaPes.getColumnModel().getColumn(5).setMinWidth(100);
        tabelaPes.getColumnModel().getColumn(5).setMaxWidth(100);
        tabelaPes.getColumnModel().getColumn(6).setMinWidth(60);
        tabelaPes.getColumnModel().getColumn(6).setMaxWidth(60);
        tabelaPes.getColumnModel().getColumn(7).setMinWidth(90);
        tabelaPes.getColumnModel().getColumn(7).setMaxWidth(90);
        tabelaPes.getColumnModel().getColumn(8).setMinWidth(75);
        tabelaPes.getColumnModel().getColumn(8).setMaxWidth(75);
        tabelaPes.getColumnModel().getColumn(9).setMinWidth(75);
        tabelaPes.getColumnModel().getColumn(9).setMaxWidth(75);
        tabelaPes.getColumnModel().getColumn(10).setMinWidth(30);
        tabelaPes.getColumnModel().getColumn(10).setMaxWidth(30);
        if (indexAtual < 0) {
            indexAtual = 0;
        }
        jTexSelecao1.setText(String.format("%s",tabelaPes.getValueAt(indexAtual,6)));
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarContasContabeis dialog = new PesquisarContasContabeis(new JFrame(),true,chamador);
