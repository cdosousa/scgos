...
import br.com.gfr.controle.CNCMProduto;
 ...
 */
public class ManterNCMProduto extends javax.swing.JFrame {

    private CNCMProduto regCorr;
    private List< CNCMProduto> resultado;
    private CNCMProduto pesq;
    private NCMProduto sqlncm;
    private int numReg;
    private int idxCorr;
    private String sql;
    private String oper;
     ...
     */
    public ManterNCMProduto(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    public ManterNCMProduto(){
        
    }

    // método para limpar tela
    public void limparTela() {
        jForCodigoNCM.setText("");
        jTexNomeNcm.setText("");
        jForCodigoOrigemCsta.setText("");
        jTexNomeOrigemCsta.setText("");
        ...
        regCorr = null;
        liberarCampos();
        jForCodigoNCM.setEditable(true);
    }

    // método para definir o tipo de pesquisa
    public void pesquisar() {

        pesq = new CNCMProduto(conexao);
        sqlncm = new NCMProduto();
        try {
    ...
    public void upRegistros() {
        ...
        pesq.mostrarPesquisa(sqlncm, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCodigoNCM.setText(sqlncm.getCdNcm().trim());
        jTexNomeNcm.setText(sqlncm.getNomeNcm().trim());
        jForCodigoOrigemCsta.setText(sqlncm.getCdOrigemCsta());
        jTexCadastradoPor.setText(sqlncm.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlncm.getDataCadastro())));
        if (sqlncm.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlncm.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlncm.getSituacao()));
    ...
    public void bloquearCampos() {
        jForCodigoNCM.setEditable(false);
        jTexNomeNcm.setEditable(false);
        jForCodigoOrigemCsta.setEditable(false);
        jComSituacao.setEditable(false);
    }

    //Loberar os campos da tela para atualização
    public void liberarCampos() {
        jTexNomeNcm.setEditable(true);
        jForCodigoOrigemCsta.setEditable(true);
    ...
    public void zoomOrigemProduto() {
        ...
        jForCodigoOrigemCsta.setText(zoom.getSelec1().trim());
        jTexNomeOrigemCsta.setText(zoom.getSelec2().trim());
    }
    ...
    private void initComponents() {
        ...
        jForCodigoNCM = new javax.swing.JFormattedTextField();
        jTexNomeNcm = new javax.swing.JTextField();
        jComSituacao = new javax.swing.JComboBox<>();
        jLabPrecRateio = new javax.swing.JLabel();
        jForCodigoOrigemCsta = new javax.swing.JFormattedTextField();
        jSeparator1 = new javax.swing.JSeparator();
        jTexNomeOrigemCsta = new javax.swing.JTextField();
        ...
        jLabReg.setText("\\");
            ...
            try {
                jForCodigoNCM.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("********")));
            } catch (java.text.ParseException ex) {
                ex.printStackTrace();
            }

            jTexNomeNcm.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeNcmActionPerformed(evt);
                }
            });
            ...
            jLabPrecRateio.setText("Origem CSTA:");

            jForCodigoOrigemCsta.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));
            jForCodigoOrigemCsta.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
            jForCodigoOrigemCsta.addKeyListener(new java.awt.event.KeyAdapter() {
                public void keyPressed(java.awt.event.KeyEvent evt) {
                    jForCodigoOrigemCstaKeyPressed(evt);
                }
            });

            jSeparator1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));

            jTexNomeOrigemCsta.setEditable(false);
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jForCodigoNCM, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jTexNomeNcm, javax.swing.GroupLayout.PREFERRED_SIZE, 357, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                        .addComponent(jForCodigoOrigemCsta, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jTexNomeOrigemCsta, javax.swing.GroupLayout.PREFERRED_SIZE, 504, javax.swing.GroupLayout.PREFERRED_SIZE))))))
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabSituacao)
                        .addComponent(jForCodigoNCM, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jTexNomeNcm, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(jSeparator1, javax.swing.GroupLayout.PREFERRED_SIZE, 1, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabPrecRateio)
                        .addComponent(jForCodigoOrigemCsta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jTexNomeOrigemCsta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGap(206, 206, 206)
    ...
    private void jTexNomeNcmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeNcmActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeNcmActionPerformed

    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCodigoNCM.getText().isEmpty() || jTexNomeNcm.getText().isEmpty() || jForCodigoOrigemCsta.getText().isEmpty() || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            JOptionPane.showMessageDialog(null, "Os campos Código, Descrição, Origem CSTA e Situacao precisam ser preenchidos corretamente!");
        } else {
            DataSistema dat = new DataSistema();
            NCMProduto ncm = new NCMProduto();
            String data = null;
            ncm.setCdNcm(jForCodigoNCM.getText().toUpperCase().toString().trim());
            ncm.setNomeNcm(jTexNomeNcm.getText().toUpperCase());
            ncm.setCdOrigemCsta(jForCodigoOrigemCsta.getText().toString().trim());
            ncm.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            ncm.setDataCadastro(data);
            ncm.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            NCMProdutoDAO ncmdao = null;
            sql = "SELECT * FROM GFRNCM WHERE CD_NCM =" + jForCodigoNCM.getText().toUpperCase().trim();
            try {
                ncmdao = new NCMProdutoDAO(conexao);
                if ("N".equals(oper)) {
                    ncmdao.adicionar(ncm);
                } else {
                    ncmdao.atualizar(ncm);
                }
            } catch (SQLException ex) {
                Logger.getLogger(ManterNCMProduto.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeNcm.getText().isEmpty()) {
            sql = "SELECT * FROM GFRNCM";
        } else {
            sql = "SELECT * FROM GFRNCM WHERE NOME_NCM LIKE '" + jTexNomeNcm.getText().trim() + "'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jForCodigoOrigemCstaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jForCodigoOrigemCstaKeyPressed
        // TODO add your handling code here:
        vt = new VerificarTecla();
        if("F5".equals(vt.VerificarTecla(evt)))
            zoomOrigemProduto();
    }//GEN-LAST:event_jForCodigoOrigemCstaKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterNCMProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterNCMProduto(su, conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField jForCodigoNCM;
    private javax.swing.JFormattedTextField jForCodigoOrigemCsta;
    ...
    private javax.swing.JTextField jTexNomeNcm;
    private javax.swing.JTextField jTexNomeOrigemCsta;
