 ...
 */
public class PesquisarCentroCustos extends JDialog{
    //Variáveis de instância privadas
    private CentroCustosDAO ccDAO;
    ...
    //Contrutor padrão
    public PesquisarCentroCustos(Frame parent, boolean modal, String chamador, Connection conexao){
        super(parent, modal);
    ...
    public void initComponentes(){
        ...
        tabelaPes = new JTable(ccDAO);
                        
        //Definindo o tamanho da Janela
        AjustarTamanhoTabela();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setModal(true);
        setTitle("Pesquisar Centro de Custos");
    ...
    public void buscarTodos(){
        try{
            ...
            ccDAO.setQuery("SELECT CD_CCUSTO AS Código,"
                    + "NOME_CCUSTO AS Nome,"
                    + "PERC_RATEIO AS Rateio,"
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_CCUSTO AS Código,"
                    + "NOME_CCUSTO AS Nome,"
                    + "PERC_RATEIO AS Rateio,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificao,"
                    + "SITUACAO AS Sit"
                    + " FROM GFRCCUSTO WHERE NOME_CCUSTO LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            ccDAO.setQuery(query);
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarCentroCustos dialog = new PesquisarCentroCustos(new JFrame(),true,chamador, conexao);
