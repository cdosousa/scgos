 ...
 */
public class PesquisarNCMProduto extends JDialog{
    //Variáveis de instância privadas
    private NCMProdutoDAO ncmDAO;
    ...
    //Contrutor padrão
    public PesquisarNCMProduto(Frame parent, boolean modal, String chamador, Connection conexao){
        super(parent, modal);
    ...
    public void initComponentes(){
        ...
        tabelaPes = new JTable(ncmDAO);
                        
        //Definindo o tamanho da Janela
        AjustarTamanhoTabela();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setModal(true);
        setTitle("Pesquisar NCM de Produtos");
    ...
    public void buscarTodos(){
        try{
            ...
            ncmDAO.setQuery("SELECT CD_NCM AS Código,"
                    + "NOME_NCM AS Nome_NCM,"
                    + "CD_ORIGEM_CSTA AS OrigemCSTA,"
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_NCM AS Código,"
                    + "NOME_NCM AS Nome_NCM,"
                    + "CD_ORIGEM_CSTA AS OrigemCSTA,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificao,"
                    + "SITUACAO AS Sit"
                    + " FROM GFRNCM WHERE NOME_NCM LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            ncmDAO.setQuery(query);
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarNCMProduto dialog = new PesquisarNCMProduto(new JFrame(),true,chamador, conexao);
