...
import br.com.gfr.controle.COrigemProduto;
 ...
 */
public class ManterOrigemProduto extends javax.swing.JFrame {

    private OrigemProduto regCorr;
    private List< OrigemProduto> resultado;
    private COrigemProduto pop;
    private OrigemProduto sqlop;
    private int numReg;
    private int idxCorr;
    private String sql;
    private String oper;
     ...
     */
    public ManterOrigemProduto(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    // construturo padrão
    public ManterOrigemProduto() {

    }

    // método para limpar tela
    public void limparTela() {
        jForCodigoOrigem.setText("");
        jTexNomeOrigem.setText("");
        jComFinalidade.setSelectedIndex(0);
        ...
        regCorr = null;
        liberarCampos();
        jForCodigoOrigem.setEditable(true);
    }

    // método para definir o tipo de pesquisa
    public void pesquisar() {

        pop = new COrigemProduto(conexao);
        sqlop = new OrigemProduto();
        try {
            numReg = pop.pesquisar(sql);
            idxCorr = +1;
            if (numReg > 0) {
                upRegistros();
            } else {
    ...
    public void upRegistros() {
        ...
        pop.mostrarPesquisa(sqlop, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCodigoOrigem.setText(sqlop.getCdOrigem().trim());
        jTexNomeOrigem.setText(sqlop.getNomeOrigem().trim());
        jComFinalidade.setSelectedIndex(Integer.parseInt(sqlop.getFinalidade()));
        jTexCadastradoPor.setText(sqlop.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlop.getDataCadastro())));
        if (sqlop.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlop.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlop.getSituacao()));
    ...
    public void bloquearCampos() {
        jForCodigoOrigem.setEditable(false);
        jTexNomeOrigem.setEditable(false);
        jComFinalidade.setEditable(false);
        jComSituacao.setEditable(false);
    }

    //Loberar os campos da tela para atualização
    public void liberarCampos() {
        jTexNomeOrigem.setEditable(true);
        jComFinalidade.setEditable(true);
    ...
    private void initComponents() {
        ...
        jForCodigoOrigem = new javax.swing.JFormattedTextField();
        jTexNomeOrigem = new javax.swing.JTextField();
        jComSituacao = new javax.swing.JComboBox<>();
        jSeparator1 = new javax.swing.JSeparator();
        jLabFinalidade = new javax.swing.JLabel();
        jComFinalidade = new javax.swing.JComboBox<>();
        ...
        jLabReg.setText("\\");
            ...
            jForCodigoOrigem.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));

            jTexNomeOrigem.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeOrigemActionPerformed(evt);
                }
            });
            ...
            jComFinalidade.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Mercadoria para Venda", "Mercadoria para Revenda", "Mercaodoria Auxiliar", "Mercadoria para Consumo" }));
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanSecundarioLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jTexNomeOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, 427, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jForCodigoOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanSecundarioLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(jComFinalidade, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabSituacao)
                        .addComponent(jForCodigoOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jTexNomeOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(jSeparator1, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabFinalidade)
                        .addComponent(jComFinalidade, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGap(216, 216, 216)
    ...
    private void jTexNomeOrigemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeOrigemActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeOrigemActionPerformed

    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCodigoOrigem.getText().isEmpty() || jTexNomeOrigem.getText().isEmpty() || jComFinalidade.getSelectedItem().toString().substring(0, 1) == " "
                || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            JOptionPane.showMessageDialog(null, "Os campos Codigo, Descrição, Situação e Finalidade  precisam ser preenchidos corretamente!");
        } else {
            DataSistema dat = new DataSistema();
            OrigemProduto op = new OrigemProduto();
            String data = null;
            op.setCdOrigem(jForCodigoOrigem.getText().toUpperCase());
            op.setNomeOrigem(jTexNomeOrigem.getText().toUpperCase());
            op.setFinalidade(String.valueOf(jComFinalidade.getSelectedIndex()));
            op.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            op.setDataCadastro(data);
            op.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            OrigemProdutoDAO opdao = null;
            sql = "SELECT * FROM GFRORIGEM WHERE CD_ORIGEM_CSTA = "
                    + "'"
                    + jForCodigoOrigem.getText().toUpperCase().trim()
                    + "'";
            try {
                ...
                Logger.getLogger(ManterOrigemProduto.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeOrigem.getText().isEmpty()) {
            sql = "SELECT * FROM GFRORIGEM";
        } else {
            sql = "SELECT * FROM GFRORIGEM WHERE NOME_ORIGEM LIKE '%" + jTexNomeOrigem.getText().trim() + "%'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        // TODO add your handling code here:
        if (!jForCodigoOrigem.getText().isEmpty()) {
            try {
                OrigemProduto cc = new OrigemProduto();
                cc.setCdOrigem(jForCodigoOrigem.getText().toUpperCase());
                OrigemProdutoDAO ccDAO = new OrigemProdutoDAO(conexao);
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            }catch(SQLException ex){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterOrigemProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterOrigemProduto(su, conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> jComFinalidade;
    private javax.swing.JComboBox<String> jComSituacao;
    private javax.swing.JFormattedTextField jForCodigoOrigem;
    ...
    private javax.swing.JTextField jTexNomeOrigem;
