 ...
 */
public class PesquisarClasseProdutos extends JDialog{
    //Variáveis de instância privadas
    private ClasseProdutosDAO cpDAO;
    ...
    //Contrutor padrão
    public PesquisarClasseProdutos(Frame parent, boolean modal, String chamador, Connection conexao){
        super(parent, modal);
    ...
    public void initComponentes(){
        ...
        tabelaPes = new JTable(cpDAO);
                        
        //Definindo o tamanho da Janela
        AjustarTamanhoTabela();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setModal(true);
        setTitle("Pesquisar Classes de Produtos");
    ...
    public void buscarTodos(){
        try{
            ...
            cpDAO.setQuery("SELECT CD_CLASSE AS Código,"
                    + "NOME_CLASSE AS Nome,"
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_CLASSE AS Código,"
                    + "NOME_CLASSE AS Nome,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificao"
                    + ",SITUACAO AS Sit"
                    + " FROM GCSCLASSE WHERE NOME_CLASSE LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            cpDAO.setQuery(query);
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarClasseProdutos dialog = new PesquisarClasseProdutos(new JFrame(),true,chamador, conexao);
