 ...
 * @author cristiano
 */
public class ManterUnidadesMedida extends javax.swing.JFrame {

    private UnidadesMedida regCorr;
    private List< UnidadesMedida> resultado;
    private CUnidadesMedida pum;
    private UnidadesMedida sqlum;
    private int numReg;
    private int idxCorr;
    private String sql;
    private String oper;
     ...
     */
    public ManterUnidadesMedida(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    // construturo padrão
    public ManterUnidadesMedida(){
        
    }

    // método para limpar tela
    public void limparTela() {
        jForCodigoUnidMedida.setText("");
        ...
        regCorr = null;
        liberarCampos();
        jForCodigoUnidMedida.setEditable(true);
    }

    // método para definir o tipo de pesquisa
    public void pesquisar() {

        pum = new CUnidadesMedida(conexao);
        sqlum = new UnidadesMedida();
        try {
            numReg = pum.pesquisar(sql);
            idxCorr = +1;
            if (numReg > 0) {
                upRegistros();
            } else {
    ...
    public void upRegistros() {
        ...
        pum.mostrarPesquisa(sqlum, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCodigoUnidMedida.setText(sqlum.getCdUnidMedida().trim());
        jTexNomeUnidMedida.setText(sqlum.getNomeUnidMedida().trim());
        jTexCadastradoPor.setText(sqlum.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlum.getDataCadastro())));
        if (sqlum.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlum.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlum.getSituacao()));
    ...
    public void bloquearCampos() {
        jForCodigoUnidMedida.setEditable(false);
    ...
    public void liberarCampos() {
        jTexNomeUnidMedida.setEditable(true);
    ...
    public void novoRegistro(){
        ...
        liberarCampos();
        jForCodigoUnidMedida.setEditable(true);
        jForCodigoUnidMedida.requestFocus();
    }
    ...
    private void initComponents() {
        ...
        jForCodigoUnidMedida = new javax.swing.JFormattedTextField();
        ...
        setTitle("Manter Unidades de Medida");
        ...
        jLabReg.setText("\\");
            ...
            try {
                jForCodigoUnidMedida.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("********")));
            } catch (java.text.ParseException ex) {
                ex.printStackTrace();
            }

            jTexNomeUnidMedida.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeUnidMedidaActionPerformed(evt);
                }
            });
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanSecundarioLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jTexNomeUnidMedida)
                                .addComponent(jForCodigoUnidMedida, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabSituacao)
                        .addComponent(jForCodigoUnidMedida, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jComSituacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jTexNomeUnidMedidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeUnidMedidaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeUnidMedidaActionPerformed

    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCodigoUnidMedida.getText().isEmpty() || jTexNomeUnidMedida.getText().isEmpty() || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            ...
            String data = null;
            um.setCdUnidMedida(jForCodigoUnidMedida.getText().toUpperCase());
            um.setNomeUnidMedida(jTexNomeUnidMedida.getText().toUpperCase());
            um.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            um.setDataCadastro(data);
            um.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            UnidadesMedidaDAO umdao = null;
            sql = "SELECT * FROM GCSUNIDMEDIDA WHERE CD_UNIDMEDIDA = "
                    + "'"
                     + jForCodigoUnidMedida.getText().toUpperCase().trim()
                    + "'";
            try {
                ...
                Logger.getLogger(ManterUnidadesMedida.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeUnidMedida.getText().isEmpty()) {
            sql = "SELECT * FROM GCSUNIDMEDIDA";
        } else {
            sql = "SELECT * FROM GCSUNIDMEDIDA WHERE NOME_UNIDMEDIDA LIKE '%" + jTexNomeUnidMedida.getText().trim() + "%'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        // TODO add your handling code here:
        if (!jForCodigoUnidMedida.getText().isEmpty()) {
            try {
                UnidadesMedida cc = new UnidadesMedida();
                cc.setCdUnidMedida(jForCodigoUnidMedida.getText().toUpperCase());
                UnidadesMedidaDAO ccDAO = new UnidadesMedidaDAO(conexao);
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterUnidadesMedida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterUnidadesMedida(su, conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField jForCodigoUnidMedida;
