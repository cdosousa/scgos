 ...
 */
public class ManterEssenciaProdutos extends javax.swing.JFrame {

    private EssenciaProdutos regCorr;
    private List< EssenciaProdutos> resultado;
    private CEssenciaProdutos pep;
    private EssenciaProdutos sqlep;
    private int numReg;
    private int idxCorr;
    private String sql;
    private String oper;
     ...
     */
    public ManterEssenciaProdutos(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    // construturo padrão
    public ManterEssenciaProdutos(){
        
    }

    // método para limpar tela
    public void limparTela() {
        jForCodigoEssencia.setText("");
        jTexNomeEssencia.setText("");
        jComFormaCodigo.setSelectedIndex(0);
        ...
        regCorr = null;
        liberarCampos();
        jForCodigoEssencia.setEditable(true);
    }

    // método para definir o tipo de pesquisa
    public void pesquisar() {

        pep = new CEssenciaProdutos(conexao);
        sqlep = new EssenciaProdutos();
        try {
            numReg = pep.pesquisar(sql);
            idxCorr = +1;
            if (numReg > 0) {
                upRegistros();
            } else {
    ...
    public void upRegistros() {
        ...
        pep.mostrarPesquisa(sqlep, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCodigoEssencia.setText(sqlep.getCdEssencia().trim());
        jTexNomeEssencia.setText(sqlep.getNomeEssencia().trim());
        jComFormaCodigo.setSelectedIndex(Integer.parseInt(sqlep.getGerarCodigo()));
        jTexCadastradoPor.setText(sqlep.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlep.getDataCadastro())));
        if (sqlep.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlep.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlep.getSituacao()));
    ...
    public void bloquearCampos() {
        jForCodigoEssencia.setEditable(false);
        jTexNomeEssencia.setEditable(false);
        jComFormaCodigo.setEditable(false);
    ...
    public void liberarCampos() {
        ...
        jComFormaCodigo.setEditable(true);
    ...
    public void novoRegistro(){
        ...
        liberarCampos();
        jForCodigoEssencia.setEditable(true);
        jForCodigoEssencia.requestFocus();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Manter Essencia de Produtos");
        ...
        jLabReg.setText("\\");
            ...
            try {
                jForCodigoEssencia.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("********")));
            } catch (java.text.ParseException ex) {
                ex.printStackTrace();
            }

            jTexNomeEssencia.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeEssenciaActionPerformed(evt);
                }
            });
            ...
            jLabFormaCodigo.setText("Forma Código:");

            jComFormaCodigo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Sim", "Não" }));
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanSecundarioLayout.createSequentialGroup()
                            ...
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jForCodigoEssencia, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jComFormaCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabSituacao)
                        .addComponent(jForCodigoEssencia, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jComSituacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabFormaCodigo)
                        .addComponent(jComFormaCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGap(234, 234, 234)
    ...
    private void jTexNomeEssenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeEssenciaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeEssenciaActionPerformed

    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCodigoEssencia.getText().isEmpty() || jTexNomeEssencia.getText().isEmpty() || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            JOptionPane.showMessageDialog(null, "Os campos Código, Descrição e Situacao precisam ser preenchidos corretamente!");
        } else {
            DataSistema dat = new DataSistema();
            EssenciaProdutos ep = new EssenciaProdutos();
            String data = null;
            ep.setCdEssencia(jForCodigoEssencia.getText().toUpperCase());
            ep.setNomeEssencia(jTexNomeEssencia.getText().toUpperCase());
            ep.setGerarCodigo(jComFormaCodigo.getSelectedItem().toString().substring(0, 1));
            ep.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            ep.setDataCadastro(data);
            ep.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            EssenciaProdutosDAO epdao = null;
            sql = "SELECT * FROM GCSESSENCIA WHERE CD_ESSENCIA = "
                    + "'"
                     + jForCodigoEssencia.getText().toUpperCase().trim()
                    + "'";
            try {
                ...
                Logger.getLogger(ManterEssenciaProdutos.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeEssencia.getText().isEmpty()) {
            sql = "SELECT * FROM GCSESSENCIA";
        } else {
            sql = "SELECT * FROM GCSESSENCIA WHERE NOME_ESSENCIA LIKE '%" + jTexNomeEssencia.getText().trim() + "%'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        // TODO add your handling code here:
        if (!jForCodigoEssencia.getText().isEmpty()) {
            try {
                EssenciaProdutos cc = new EssenciaProdutos();
                cc.setCdEssencia(jForCodigoEssencia.getText().toUpperCase());
                EssenciaProdutosDAO ccDAO = new EssenciaProdutosDAO(conexao);
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterEssenciaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterEssenciaProdutos(su, conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> jComFormaCodigo;
    private javax.swing.JComboBox<String> jComSituacao;
    private javax.swing.JFormattedTextField jForCodigoEssencia;
