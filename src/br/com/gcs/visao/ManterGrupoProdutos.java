 ...
 * @author cristiano
 */
public class ManterGrupoProdutos extends javax.swing.JFrame {

    private GrupoProdutos regCorr;
    private List< GrupoProdutos> resultado;
    private CGrupoProdutos pgp;
    private GrupoProdutos sqlgp;
    private int numReg;
    private int idxCorr;
    private String sql;
    private String oper;
     ...
     */
    public ManterGrupoProdutos(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    // construturo padrão
    public ManterGrupoProdutos(){
        
    }

    // método para limpar tela
    public void limparTela() {
        jForCodigoGrupo.setText("");
        ...
        regCorr = null;
        liberarCampos();
        jForCodigoGrupo.setEditable(true);
    }

    // método para definir o tipo de pesquisa
    public void pesquisar() {

        pgp = new CGrupoProdutos(conexao);
        sqlgp = new GrupoProdutos();
        try {
            numReg = pgp.pesquisar(sql);
            idxCorr = +1;
            if (numReg > 0) {
                upRegistros();
            } else {
    ...
    public void upRegistros() {
        ...
        pgp.mostrarPesquisa(sqlgp, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCodigoGrupo.setText(sqlgp.getCdGrupo().trim());
        jTexNomeGrupo.setText(sqlgp.getNomeGrupo().trim());
        jComGerarCodigo.setSelectedIndex(Integer.parseInt(sqlgp.getGerarCodigo()));
        jTexCadastradoPor.setText(sqlgp.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlgp.getDataCadastro())));
        if (sqlgp.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlgp.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlgp.getSituacao()));
    ...
    public void bloquearCampos() {
        jForCodigoGrupo.setEditable(false);
    ...
    public void liberarCampos() {
        jTexNomeGrupo.setEditable(true);
    ...
    private void initComponents() {
        ...
        jForCodigoGrupo = new javax.swing.JFormattedTextField();
        ...
        jLabReg.setText("\\");
            ...
            try {
                jForCodigoGrupo.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("********")));
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanSecundarioLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jTexNomeGrupo)
                                .addComponent(jForCodigoGrupo, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabSituacao)
                        .addComponent(jForCodigoGrupo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jComSituacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCodigoGrupo.getText().isEmpty() || jTexNomeGrupo.getText().isEmpty() || jComGerarCodigo.getSelectedItem().toString().substring(0, 1) == " " || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            ...
            String data = null;
            gp.setCdGrupo(jForCodigoGrupo.getText().toUpperCase());
            gp.setNomeGrupo(jTexNomeGrupo.getText().toUpperCase());
            gp.setGerarCodigo(jComGerarCodigo.getSelectedItem().toString().substring(0, 1));
            gp.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            gp.setDataCadastro(data);
            gp.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            GrupoProdutosDAO gpdao = null;
            sql = "SELECT * FROM GCSGRUPOS WHERE CD_GRUPO = "
                    + "'"
                     + jForCodigoGrupo.getText().toUpperCase().trim()
                    + "'";
            try {
                ...
                Logger.getLogger(ManterGrupoProdutos.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeGrupo.getText().isEmpty()) {
            sql = "SELECT * FROM GCSGRUPOS";
        } else {
            sql = "SELECT * FROM GCSGRUPOS WHERE NOME_GRUPO LIKE '%" + jTexNomeGrupo.getText().trim() + "%'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        // TODO add your handling code here:
        if (!jForCodigoGrupo.getText().isEmpty()) {
            try {
                GrupoProdutos cc = new GrupoProdutos();
                cc.setCdGrupo(jForCodigoGrupo.getText().toUpperCase());
                GrupoProdutosDAO ccDAO = new GrupoProdutosDAO(conexao);
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterGrupoProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterGrupoProdutos(su,conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField jForCodigoGrupo;
