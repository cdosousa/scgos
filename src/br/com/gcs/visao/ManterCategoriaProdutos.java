...
import br.com.gcs.controle.CCategorias;
 ...
 * @author cristiano
 */
public class ManterCategoriaProdutos extends javax.swing.JFrame {

    private Categorias regCorr;
    private List< Categorias> resultado;
    private CCategorias pcat;
    private Categorias sqlcat;
    private int numReg;
    private int idxCorr;
    private String sql;
    private String oper;
     ...
     */
    public ManterCategoriaProdutos(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    // construturo padrão
    public ManterCategoriaProdutos(){
        
    }

    // método para limpar tela
    public void limparTela() {
        jForCodigoCategoria.setText("");
        ...
        regCorr = null;
        liberarCampos();
        jForCodigoCategoria.setEditable(true);
    }

    // método para definir o tipo de pesquisa
    public void pesquisar() {

        pcat = new CCategorias(conexao);
        sqlcat = new Categorias();
        try {
            numReg = pcat.pesquisar(sql);
            idxCorr = +1;
            if (numReg > 0) {
                upRegistros();
            } else {
    ...
    public void upRegistros() {
        ...
        pcat.mostrarPesquisa(sqlcat, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCodigoCategoria.setText(sqlcat.getCdCategoria().trim());
        jTexNomeCategoria.setText(sqlcat.getNomeCategoria().trim());
        jComGerarCodigo.setSelectedIndex(Integer.parseInt(sqlcat.getGerarCodigo()));
        jTexCadastradoPor.setText(sqlcat.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlcat.getDataCadastro())));
        if (sqlcat.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlcat.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlcat.getSituacao()));
    ...
    public void bloquearCampos() {
        jForCodigoCategoria.setEditable(false);
    ...
    public void liberarCampos() {
        jTexNomeCategoria.setEditable(true);
    ...
    public void novoRegistro(){
        ...
        liberarCampos();
        jForCodigoCategoria.setEditable(true);
        jForCodigoCategoria.requestFocus();
    }
    ...
    private void initComponents() {
        ...
        jForCodigoCategoria = new javax.swing.JFormattedTextField();
        ...
        setTitle("Manter Categoria de Produtos");
        ...
        jLabReg.setText("\\");
            ...
            try {
                jForCodigoCategoria.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("********")));
            } catch (java.text.ParseException ex) {
                ex.printStackTrace();
            }

            jTexNomeCategoria.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeCategoriaActionPerformed(evt);
                }
            });
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanSecundarioLayout.createSequentialGroup()
                            ...
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jForCodigoCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jComGerarCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabSituacao)
                        .addComponent(jForCodigoCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jComSituacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jTexNomeCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeCategoriaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeCategoriaActionPerformed

    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCodigoCategoria.getText().isEmpty() || jTexNomeCategoria.getText().isEmpty() || jComGerarCodigo.getSelectedItem().toString().substring(0, 1) == " " || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            JOptionPane.showMessageDialog(null, "Os campos Código, Descrição, Gerador de Código e Situacao precisam ser preenchidos corretamente!");
        } else {
            DataSistema dat = new DataSistema();
            Categorias cat = new Categorias();
            String data = null;
            cat.setCdCategoria(jForCodigoCategoria.getText().toUpperCase());
            cat.setNomeCategoria(jTexNomeCategoria.getText().toUpperCase());
            cat.setGerarCodigo(jComGerarCodigo.getSelectedItem().toString().substring(0, 1));
            cat.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            cat.setDataCadastro(data);
            cat.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            CategoriasDAO catdao = null;
            sql = "SELECT * FROM GCSCATEGORIA WHERE CD_CATEGORIA = "
                    + "'"
                     + jForCodigoCategoria.getText().toUpperCase().trim()
                    + "'";
            try {
                catdao = new CategoriasDAO(conexao);
                if ("N".equals(oper))
                    catdao.adicionar(cat);
                else
                    catdao.atualizar(cat);
            } catch (SQLException ex) {
                Logger.getLogger(ManterCategoriaProdutos.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeCategoria.getText().isEmpty()) {
            sql = "SELECT * FROM GCSCATEGORIA";
        } else {
            sql = "SELECT * FROM GCSCATEGORIA WHERE NOME_CATEGORIA LIKE '%" + jTexNomeCategoria.getText().trim() + "%'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        // TODO add your handling code here:
        if (!jForCodigoCategoria.getText().isEmpty()) {
            try {
                Categorias cc = new Categorias();
                cc.setCdCategoria(jForCodigoCategoria.getText().toUpperCase());
                CategoriasDAO ccDAO = new CategoriasDAO(conexao);
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterCategoriaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterCategoriaProdutos(su, conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField jForCodigoCategoria;
