 ...
 */
public class PesquisarCategoriaProdutos extends JDialog{
    ...
    //Contrutor padrão
    public PesquisarCategoriaProdutos(Frame parent, boolean modal, String chamador, Connection conexao){
        super(parent, modal);
    ...
    public void initComponentes(){
        ...
        tabelaPes = new JTable(catDAO);
                        
        //Definindo o tamanho da Janela
        AjustarTamanhoTabela();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setModal(true);
        setTitle("Pesquisar Categoria de Produtos");
    ...
    public void buscarTodos(){
        try{
            catDAO = new CategoriasDAO(conexao);
            catDAO.setQuery("SELECT CD_CATEGORIA AS Categoria,"
                    + "NOME_CATEGORIA AS Nome,"
                    + "GERAR_CODIGO AS Formar_Código,"
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_CATEGORIA AS Categoria,"
                    + "NOME_CATEGORIA AS Nome,"
                    + "GERAR_CODIGO AS Formar_Código,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificação,"
                    + "SITUACAO AS Sit"
                    + " FROM GCSCATEGORIA WHERE NOME_CATEGORIA LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            catDAO.setQuery(query);
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarCategoriaProdutos dialog = new PesquisarCategoriaProdutos(new JFrame(),true,chamador, conexao);
