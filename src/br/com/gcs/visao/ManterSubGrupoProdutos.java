...
import br.com.gcs.controle.CGrupoProdutos;
import br.com.gcs.controle.CSubGrupoProdutos;
 ...
 */
public class ManterSubGrupoProdutos extends javax.swing.JFrame {

    private SubGrupoProdutos regCorr;
    private List< SubGrupoProdutos> resultado;
    private CSubGrupoProdutos psgp;
    private SubGrupoProdutos sqlsgp;
    private int numReg;
    private int idxCorr;
    private String sql;
    private String oper;
    private static SessaoUsuario su;
    private static VerificarTecla vt;
    private static Connection conexao;

    /**
     * Creates new form ManterProdutos
     */
    public ManterSubGrupoProdutos(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    public void limparTela() {
        ...
        jForCdSubGrupo.setText("");
        jTexNomeSubGrupo.setText("");
        jComGerarCodigo.setSelectedIndex(0);
        ...
        regCorr = null;
        liberarCampos();
        jForCdGrupo.setEditable(true);
        jForCdSubGrupo.setEditable(true);
    }

    // método para definir o tipo de pesquisa
    public void pesquisar() {

        psgp = new CSubGrupoProdutos(conexao);
        sqlsgp = new SubGrupoProdutos();
        try {
            numReg = psgp.pesquisar(sql);
            idxCorr = +1;
            if (numReg > 0) {
                upRegistros();
            } else {
    ...
    public void upRegistros() {
        ...
        psgp.mostrarPesquisa(sqlsgp, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCdGrupo.setText(sqlsgp.getCdGrupo().trim());
        jForCdSubGrupo.setText(sqlsgp.getCdSubGrupo().trim());
        jTexNomeSubGrupo.setText(sqlsgp.getNomeSubGrupo().trim());
        jComGerarCodigo.setSelectedIndex(Integer.parseInt(sqlsgp.getGerarCodigo()));
        jTexCadastradoPor.setText(sqlsgp.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlsgp.getDataCadastro())));
        if (sqlsgp.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlsgp.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlsgp.getSituacao()));
        ...
        String sql1 = "Select * from gcsgrupos where cd_grupo = '"
                + jForCdGrupo.getText()
                + "'";
        try {
            cgp.pesquisar(sql1);
            ...
            Logger.getLogger(ManterSubGrupoProdutos.class.getName()).log(Level.SEVERE, null, ex);
        }
        jTexNomeGrupo.setText(gp.getNomeGrupo());
    }

    //Bloquear os campos da tela
    public void bloquearCampos() {
        jForCdGrupo.setEditable(false);
        jForCdSubGrupo.setEditable(false);
        jTexNomeSubGrupo.setEditable(false);
        jComGerarCodigo.setEditable(false);
        jComSituacao.setEditable(false);
    }

    //Loberar os campos da tela para atualização
    public void liberarCampos() {
        jTexNomeSubGrupo.setEditable(true);
        jComGerarCodigo.setEditable(true);
    ...
    private void initComponents() {
        ...
        setTitle("Manter Grupo de Produtos");
        ...
        jLabReg.setText("\\");
            ...
            jLabCodigoSubGrupo.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
            jLabCodigoSubGrupo.setText("Sub Grupo:");
            ...
            try {
                jForCdSubGrupo.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("***")));
            } catch (java.text.ParseException ex) {
                ex.printStackTrace();
            }

            jTexNomeSubGrupo.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeSubGrupoActionPerformed(evt);
                }
            });

            jComSituacao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Ativo", "Inativo" }));

            jLabGerarCodigo.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
            jLabGerarCodigo.setText("Gerador de Código:");

            jComGerarCodigo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Sim", "Não" }));
            ...
            jTexNomeGrupo.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeGrupoActionPerformed(evt);
                }
            });

            try {
                jForCdGrupo.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("***")));
            } catch (java.text.ParseException ex) {
                ex.printStackTrace();
            }
            jForCdGrupo.addKeyListener(new java.awt.event.KeyAdapter() {
                public void keyPressed(java.awt.event.KeyEvent evt) {
                    jForCdGrupoKeyPressed(evt);
                }
            });
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanSecundarioLayout.createSequentialGroup()
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jLabCodigoSubGrupo, javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addComponent(jLabGerarCodigo)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jComGerarCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(140, 140, 140))
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(jForCdSubGrupo, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
                                        .addComponent(jForCdGrupo))
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jTexNomeGrupo, javax.swing.GroupLayout.PREFERRED_SIZE, 421, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(77, 77, 77)
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jForCdGrupo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabCodigoSubGrupo)
                        .addComponent(jForCdSubGrupo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabGerarCodigo)
                        .addComponent(jComGerarCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGap(213, 213, 213)
    ...
    private void jTexNomeSubGrupoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeSubGrupoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeSubGrupoActionPerformed

    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCdGrupo.getText().isEmpty() || jForCdSubGrupo.getText().isEmpty() || jTexNomeSubGrupo.getText().isEmpty()
                || jComGerarCodigo.getSelectedItem().toString().substring(0, 1) == " " || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            JOptionPane.showMessageDialog(null, "Os campos Grúpo, SubGrupo, Descrição, Gerador de Código e Situacao precisam ser preenchidos corretamente!");
        } else {
            DataSistema dat = new DataSistema();
            SubGrupoProdutos sgp = new SubGrupoProdutos();
            String data = null;
            sgp.setCdGrupo(jForCdGrupo.getText().toUpperCase().trim());
            sgp.setCdSubGrupo(jForCdSubGrupo.getText().toUpperCase().trim());
            sgp.setNomeSubGrupo(jTexNomeSubGrupo.getText().toUpperCase());
            sgp.setGerarCodigo(jComGerarCodigo.getSelectedItem().toString().substring(0, 1));
            sgp.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            sgp.setDataCadastro(data);
            sgp.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            SubGrupoProdutosDAO sgpdao = null;
            sql = "SELECT * FROM GCSSUBGRUPOS WHERE CD_SUBGRUPO = "
                    + "'"
                    + jForCdSubGrupo.getText().toUpperCase().trim()
                    + "' AND CD_GRUPO = "
                    + "'"
                    + jForCdGrupo.getText().toUpperCase().trim()
                    + "'";
            try {
                sgpdao = new SubGrupoProdutosDAO(conexao);
                if ("N".equals(oper)) {
                    sgpdao.adicionar(sgp);
                } else {
                    sgpdao.atualizar(sgp);
                }
            } catch (SQLException ex) {
                Logger.getLogger(ManterSubGrupoProdutos.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeSubGrupo.getText().isEmpty()) {
            sql = "SELECT * FROM GCSSUBGRUPOS ORDER BY CD_GRUPO";
        } else {
            sql = "SELECT * FROM GCSSUBGRUPOS WHERE NOME_SUBGRUPO LIKE '%" + jTexNomeSubGrupo.getText().trim() + "%'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jTexNomeGrupoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeGrupoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeGrupoActionPerformed

    private void jForCdGrupoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jForCdGrupoKeyPressed
        // TODO add your handling code here:
        vt = new VerificarTecla();
        if("F5".equals(vt.VerificarTecla(evt)))
            zoomGrupos();
    }//GEN-LAST:event_jForCdGrupoKeyPressed

    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        // TODO add your handling code here:
        if (!jForCdSubGrupo.getText().isEmpty()) {
            try {
                SubGrupoProdutos cc = new SubGrupoProdutos();
                cc.setCdGrupo(jForCdGrupo.getText().toUpperCase());
                cc.setCdSubGrupo(jForCdSubGrupo.getText().toUpperCase());
                SubGrupoProdutosDAO ccDAO = new SubGrupoProdutosDAO(conexao);
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterSubGrupoProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterSubGrupoProdutos(su, conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> jComGerarCodigo;
    private javax.swing.JComboBox<String> jComSituacao;
    private javax.swing.JFormattedTextField jForCdGrupo;
    private javax.swing.JFormattedTextField jForCdSubGrupo;
    ...
    private javax.swing.JLabel jLabCodigoSubGrupo;
    ...
    private javax.swing.JLabel jLabGerarCodigo;
