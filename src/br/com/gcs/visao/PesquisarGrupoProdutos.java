 ...
 */
public class PesquisarGrupoProdutos extends JDialog{
    //Variáveis de instância privadas
    private GrupoProdutosDAO gpDAO;
    ...
    //Contrutor padrão
    public PesquisarGrupoProdutos(Frame parent, boolean modal, String chamador, Connection conexao){
        super(parent, modal);
    ...
    public void buscarTodos(){
        try{
            gpDAO = new GrupoProdutosDAO(conexao);
            gpDAO.setQuery("SELECT CD_GRUPO AS Grupo,"
                    + "NOME_GRUPO AS Nome,"
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_GRUPO AS Grupo,"
                    + "NOME_GRUPO AS Nome,"
                    + "GERAR_CODIGO AS Forma_Código,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificação,"
                    + "SITUACAO AS Sit"
                    + " FROM GCSGRUPOS WHERE NOME_GRUPO LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            gpDAO.setQuery(query);
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarGrupoProdutos dialog = new PesquisarGrupoProdutos(new JFrame(),true,chamador, conexao);
