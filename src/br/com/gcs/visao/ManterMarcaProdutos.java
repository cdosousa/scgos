...
import br.com.gcs.controle.CMarcaProdutos;
 ...
 * @author cristiano
 */
public class ManterMarcaProdutos extends javax.swing.JFrame {

    private MarcaProdutos regCorr;
    private List< MarcaProdutos> resultado;
    private CMarcaProdutos pmp;
    private MarcaProdutos sqlmp;
    private int numReg;
    private int idxCorr;
    private String sql;
    private String oper;
     ...
     */
    public ManterMarcaProdutos(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    // construturo padrão
    public ManterMarcaProdutos(){
        
    }

    // método para limpar tela
    public void limparTela() {
        jForCodigoMarca.setText("");
        ...
        regCorr = null;
        liberarCampos();
        jForCodigoMarca.setEditable(true);
    }

    // método para definir o tipo de pesquisa
    public void pesquisar() {

        pmp = new CMarcaProdutos(conexao);
        sqlmp = new MarcaProdutos();
        try {
            numReg = pmp.pesquisar(sql);
            idxCorr = +1;
            if (numReg > 0) {
                upRegistros();
            } else {
    ...
    public void upRegistros() {
        ...
        pmp.mostrarPesquisa(sqlmp, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCodigoMarca.setText(sqlmp.getCdMarca().trim());
        jTexNomeMarca.setText(sqlmp.getNomeMarca().trim());
        jTexCadastradoPor.setText(sqlmp.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlmp.getDataCadastro())));
        if (sqlmp.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlmp.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlmp.getSituacao()));
    ...
    public void bloquearCampos() {
        jForCodigoMarca.setEditable(false);
    ...
    public void liberarCampos() {
        jTexNomeMarca.setEditable(true);
    ...
    private void initComponents() {
        ...
        jForCodigoMarca = new javax.swing.JFormattedTextField();
        ...
        setTitle("Manter Marca de Produtos");
        ...
        jLabReg.setText("\\");
            ...
            try {
                jForCodigoMarca.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("********")));
            } catch (java.text.ParseException ex) {
                ex.printStackTrace();
            }

            jTexNomeMarca.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeMarcaActionPerformed(evt);
                }
            });
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanSecundarioLayout.createSequentialGroup()
                            ...
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jForCodigoMarca, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabSituacao)
                        .addComponent(jForCodigoMarca, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jComSituacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jTexNomeMarcaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeMarcaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeMarcaActionPerformed

    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCodigoMarca.getText().isEmpty() || jTexNomeMarca.getText().isEmpty() || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            JOptionPane.showMessageDialog(null, "Os campos Código, Descrição e Situacao precisam ser preenchidos corretamente!");
        } else {
            DataSistema dat = new DataSistema();
            MarcaProdutos mp = new MarcaProdutos();
            String data = null;
            mp.setCdMarca(jForCodigoMarca.getText().toUpperCase());
            mp.setNomeMarca(jTexNomeMarca.getText().toUpperCase());
            mp.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            mp.setDataCadastro(data);
            mp.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            MarcaProdutosDAO umdao = null;
            sql = "SELECT * FROM GCSMARCA WHERE CD_MARCA = "
                    + "'"
                     + jForCodigoMarca.getText().toUpperCase().trim()
                    + "'";
            try {
                umdao = new MarcaProdutosDAO(conexao);
                if ("N".equals(oper))
                    umdao.adicionar(mp);
                else
                    umdao.atualizar(mp);
            } catch (SQLException ex) {
                Logger.getLogger(ManterMarcaProdutos.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeMarca.getText().isEmpty()) {
            sql = "SELECT * FROM GCSMARCA";
        } else {
            sql = "SELECT * FROM GCSMARCA WHERE NOME_MARCA LIKE '%" + jTexNomeMarca.getText().trim() + "%'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        // TODO add your handling code here:
        if (!jForCodigoMarca.getText().isEmpty()) {
            try {
                MarcaProdutos cc = new MarcaProdutos();
                cc.setCdMarca(jForCodigoMarca.getText().toUpperCase());
                MarcaProdutosDAO ccDAO = new MarcaProdutosDAO(conexao);
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterMarcaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterMarcaProdutos(su, conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField jForCodigoMarca;
