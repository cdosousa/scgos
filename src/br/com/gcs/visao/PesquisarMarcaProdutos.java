 ...
 */
public class PesquisarMarcaProdutos extends JDialog{
    //Variáveis de instância privadas
    private MarcaProdutosDAO mpDAO;
    ...
    //Contrutor padrão
    public PesquisarMarcaProdutos(Frame parent, boolean modal, String chamador, Connection conexao){
        super(parent, modal);
    ...
    public void initComponentes(){
        ...
        tabelaPes = new JTable(mpDAO);
                        
        //Definindo o tamanho da Janela
        AjustarTamanhoTabela();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setModal(true);
        setTitle("Pesquisar Marcas de Produtos");
    ...
    public void buscarTodos(){
        try{
            mpDAO = new MarcaProdutosDAO(conexao);
            mpDAO.setQuery("SELECT CD_MARCA AS Código,"
                    + "NOME_MARCA AS Nome,"
    ...
    public void buscarPorNome(){
        try{
            String query = "SELECT CD_MARCA AS Código,"
                    + "NOME_MARCA AS Nome,"
                    + "DATA_CADASTRO AS Cadastro,"
                    + "DATA_MODIFICACAO AS Modificao"
                    + ",SITUACAO AS Sit"
                    + " FROM GCSMARCA WHERE NOME_MARCA LIKE "
                    + "'%"
                    + jTexPesqNome.getText()
                    + "%'";
            mpDAO.setQuery(query);
    ...
    public static void main(String[]args){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                PesquisarMarcaProdutos dialog = new PesquisarMarcaProdutos(new JFrame(),true,chamador, conexao);
