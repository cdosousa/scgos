...
import br.com.gcs.controle.CArmazens;
 ...
 */
public class ManterArmazens extends javax.swing.JFrame {

    private Armazens regCorr;
    private List< Armazens> resultado;
    private CArmazens pcd;
    private Armazens sqlcd;
     ...
     */
    public ManterArmazens(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    // construturo padrão
    public ManterArmazens(){
        
    }

    // método para limpar tela
    public void limparTela() {
        jForCodigoArmazem.setText("");
        jTexNomeArmazem.setText("");
        jComTipoArmazem.setSelectedIndex(0);
        jComPermiteSeparacao.setSelectedIndex(0);
        ...
        regCorr = null;
        liberarCampos();
        jForCodigoArmazem.setEditable(true);
    }

    // método para definir o tipo de pesquisa
    public void pesquisar() {

        pcd = new CArmazens(conexao);
        sqlcd = new Armazens();
        try {
            numReg = pcd.pesquisar(sql);
            idxCorr = +1;
            if (numReg > 0) {
                upRegistros();
            } else {
    ...
    public void upRegistros() {
        ...
        pcd.mostrarPesquisa(sqlcd, idxCorr - 1);
        DataSistema dat = new DataSistema();
        jForCodigoArmazem.setText(sqlcd.getCdArmazem().trim());
        jTexNomeArmazem.setText(sqlcd.getNomeArmazem().trim());
        jComTipoArmazem.setSelectedIndex(Integer.parseInt(sqlcd.getTipoArmazem()));
        jComPermiteSeparacao.setSelectedIndex(Integer.parseInt(sqlcd.getPermiteSeparacao()));
        jTexCadastradoPor.setText(sqlcd.getUsuarioCadastro());
        jForDataCadastro.setText(dat.getDataConv(Date.valueOf(sqlcd.getDataCadastro())));
        if (sqlcd.getDataModificacao() != null) {
            jForDataModificacao.setText(dat.getDataConv(Date.valueOf(sqlcd.getDataModificacao())));
        }
        jComSituacao.setSelectedIndex(Integer.parseInt(sqlcd.getSituacao()));
    ...
    public void bloquearCampos() {
        jForCodigoArmazem.setEditable(false);
        jTexNomeArmazem.setEditable(false);
        jComTipoArmazem.setEditable(false);
        jComPermiteSeparacao.setEditable(false);
        jComSituacao.setEditable(false);
    }

    //Loberar os campos da tela para atualização
    public void liberarCampos() {
        jTexNomeArmazem.setEditable(true);
        jComTipoArmazem.setEditable(true);
        jComPermiteSeparacao.setEditable(true);
    ...
    public void novoRegistro(){
        ...
        liberarCampos();
        jForCodigoArmazem.setEditable(true);
        jForCodigoArmazem.requestFocus();
    }
    ...
    private void initComponents() {
        ...
        jForCodigoArmazem = new javax.swing.JFormattedTextField();
        jTexNomeArmazem = new javax.swing.JTextField();
        jComSituacao = new javax.swing.JComboBox<>();
        jLabFormaCodigo = new javax.swing.JLabel();
        jComPermiteSeparacao = new javax.swing.JComboBox<>();
        jLabTipoArmazem = new javax.swing.JLabel();
        jComTipoArmazem = new javax.swing.JComboBox<>();
        ...
        jLabReg.setText("\\");
            ...
            try {
                jForCodigoArmazem.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("********")));
            } catch (java.text.ParseException ex) {
                ex.printStackTrace();
            }

            jTexNomeArmazem.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jTexNomeArmazemActionPerformed(evt);
                }
            });
            ...
            jLabFormaCodigo.setText("Permite Separação:");

            jComPermiteSeparacao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Sim", "Não" }));

            jLabTipoArmazem.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
            jLabTipoArmazem.setText("Tipo Aramzém:");

            jComTipoArmazem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Próprio", "Terceiro" }));
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanSecundarioLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jTexNomeArmazem)
                                .addComponent(jForCodigoArmazem, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jComTipoArmazem, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(jLabSituacao))
                                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                                    .addComponent(jLabFormaCodigo)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jComPermiteSeparacao, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(6, 6, 6)))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            jPanSecundarioLayout.setVerticalGroup(
                ...
                .addGroup(jPanSecundarioLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabSituacao)
                        .addComponent(jForCodigoArmazem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jComSituacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabTipoArmazem)
                        .addComponent(jComTipoArmazem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                    .addGroup(jPanSecundarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabDescricao)
                        .addComponent(jTexNomeArmazem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabFormaCodigo)
                        .addComponent(jComPermiteSeparacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGap(234, 234, 234)
    ...
    private void jTexNomeArmazemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTexNomeArmazemActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTexNomeArmazemActionPerformed

    private void jButSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButSalvarActionPerformed
        // TODO add your handling code here:
        if (jForCodigoArmazem.getText().isEmpty() || jTexNomeArmazem.getText().isEmpty() || jComTipoArmazem.getSelectedItem().toString().substring(0, 1) == " " || jComPermiteSeparacao.getSelectedItem().toString().substring(0, 1) == " " || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            JOptionPane.showMessageDialog(null, "Os campos Código, Descrição, Tipo de Armazém, Permite Separação e Situacao precisam ser preenchidos corretamente!");
        } else {
            DataSistema dat = new DataSistema();
            Armazens cd = new Armazens();
            String data = null;
            cd.setCdArmazem(jForCodigoArmazem.getText().toUpperCase());
            cd.setNomeArmazem(jTexNomeArmazem.getText().toUpperCase());
            cd.setTipoArmazem(jComTipoArmazem.getSelectedItem().toString().substring(0, 1));
            cd.setPermiteSeparacao(jComPermiteSeparacao.getSelectedItem().toString().substring(0, 1));
            cd.setUsuarioCadastro(su.getUsuarioConectado());
            dat.setData(data);
            data = dat.getData();
            cd.setDataCadastro(data);
            cd.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
            ArmazensDAO cddao = null;
            sql = "SELECT * FROM GCSARMAZEM WHERE CD_ARMAZEM = "
                    + "'"
                     + jForCodigoArmazem.getText().toUpperCase().trim()
                    + "'";
            try {
                cddao = new ArmazensDAO(conexao);
                if ("N".equals(oper))
                    cddao.adicionar(cd);
                else
                    cddao.atualizar(cd);
            } catch (SQLException ex) {
                Logger.getLogger(ManterArmazens.class.getName()).log(Level.SEVERE, null, ex);
            }
            limparTela();
            bloquearCampos();
            pesquisar();
    ...
    private void jButPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPesquisarActionPerformed
        // TODO add your handling code here:
        if (jTexNomeArmazem.getText().isEmpty()) {
            sql = "SELECT * FROM GCSARMAZEM";
        } else {
            sql = "SELECT * FROM GCSARMAZEM WHERE NOME_ARMAZEM LIKE '%" + jTexNomeArmazem.getText().trim() + "%'";
        }
        bloquearCampos();
        pesquisar();
    ...
    private void jButExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButExcluirActionPerformed
        // TODO add your handling code here:
        if (!jForCodigoArmazem.getText().isEmpty()) {
            try {
                Armazens cc = new Armazens();
                cc.setCdArmazem(jForCodigoArmazem.getText().toUpperCase());
                ArmazensDAO ccDAO = new ArmazensDAO(conexao);
                ccDAO.excluir(cc);
                limparTela();
                jButPesquisarActionPerformed(evt);
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterArmazens.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterArmazens(su,conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> jComPermiteSeparacao;
    private javax.swing.JComboBox<String> jComSituacao;
    private javax.swing.JComboBox<String> jComTipoArmazem;
    private javax.swing.JFormattedTextField jForCodigoArmazem;
    ...
    private javax.swing.JTextField jTexNomeArmazem;
