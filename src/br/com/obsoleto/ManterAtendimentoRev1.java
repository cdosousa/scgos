 ...
 */
public class ManterAtendimentoRev1 extends javax.swing.JFrame {
    ...
    private boolean editarTabela = false;

    // construturo padrão
    public ManterAtendimentoRev1() {

    }

    public ManterAtendimentoRev1(SessaoUsuario su, Connection conexao) {
        this.su = su;
    ...
    public ManterAtendimentoRev1(SessaoUsuario su, Connection conexao, Contato modcon) {
        this.su = su;
        this.conexao = conexao;
    ...
    private void pesquisarItens() {
        ...
        try {
            ...
            Logger.getLogger(ManterAtendimentoRev1.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (numRegItens > 0) {
    ...
    private void atualizarTotaisAtendimento() {
        int numReg = 0;
        citl = new CItemLocal(conexao);
        String sqlate = "select l.cd_atendimento as Atendimento,"
                + " l.cd_local as Ambiente,"
                + " (l.valor_produtos) as 'Total Produtos',"
                ...
                + "'";
        try {
            numReg = citl.pesquisarTotais(sqlate);
        } catch (SQLException ex) {
            Logger.getLogger(ManterAtendimentoRev1.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (numReg > 0) {
            citl.upTotalAmbiente(modlat);
            jForTotalMateriais.setText(String.valueOf(modlat.getValorProdutos()));
            jForTotalServico.setText(String.valueOf(modlat.getValorServico()));
            jForTotalAdicionais.setText(String.valueOf(modlat.getValorAdicionais()));
            jForValorTotal.setText(String.valueOf(modlat.getValorTotalBruto()));

            ate.setValorProdutos(modlat.getValorProdutos());
            ate.setValorServico(modlat.getValorServico());
            ate.setValorAdicionais(modlat.getValorAdicionais());
            ate.setValorTotalBruto(modlat.getValorTotalBruto());
            operAnted = "A";
            salvarAtendimento();
            operAnted = "";
        }
        ...
        jTabItensLocal.addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if ("GUIA".equals(tecla)) {
                    ...
                    moditl.setQuantidade(Double.valueOf(String.format("%s", jTabItensLocal.getValueAt(linhaItem, 4))));
                    moditl.setValorUnitBruto(Double.valueOf(String.format("%s", jTabItensLocal.getValueAt(linhaItem, 5))));
                    moditl.setValorTotalItemBruto(moditl.getQuantidade() * moditl.getValorUnitBruto());
                    upValue();
                }
    ...
    private void zoomTipoVerniz() {
        PesquisarTipoVerniz zoom = new PesquisarTipoVerniz(this, true, "P", conexao);
        zoom.setVisible(true);
    ...
    private void zoomTipoPagamento() {
        PesquisarTipoPagamento zoom = new PesquisarTipoPagamento(this, true, "P", conexao);
        zoom.setVisible(true);
        jTexCdTipoPagto.setText(zoom.getCdTipoPagamento());
        jTexNomeTipoPagto.setText(zoom.getNomeTipoPagamento());
    ...
    private void salvarAtendimento() {
        if (jTexNomeRazaoSocial.getText().isEmpty() || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            ...
            data = dat.getData();
            HoraSistema hs = new HoraSistema();
            ate.setSituacao(jComSituacao.getSelectedItem().toString().substring(0, 1));
    ...
    private void calcularPagamento() {
        try {
            ...
            double fatorJuros = Math.pow((1 + txJuros / 100), parcelas);
            jForValorParcelas.setText(String.valueOf((totalAtendimento * fatorJuros) / parcelas));
        } catch (ParseException ex) {
            Logger.getLogger(ManterAtendimentoRev1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jTexCdTipoPagto = new javax.swing.JTextField();
        jLabTipoPagamento = new javax.swing.JLabel();
        jTexNomeTipoPagto = new javax.swing.JTextField();
        ...
        jPanEnderecoLayout.setHorizontalGroup(
            ...
            .addGroup(jPanEnderecoLayout.createSequentialGroup()
                .addGroup(jPanEnderecoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabComplemento, javax.swing.GroupLayout.Alignment.TRAILING))
        ...
        jLabRegAtend.setText("\\");
            ...
            jTabbedPaneDetalhes.getAccessibleContext().setAccessibleName("Ambiente");
            ...
            jLabRegLocal.setText("\\");
                ...
                jTexCdTipoPagto.addKeyListener(new java.awt.event.KeyAdapter() {
                    public void keyPressed(java.awt.event.KeyEvent evt) {
                        jTexCdTipoPagtoKeyPressed(evt);
                    }
                });

                jLabTipoPagamento.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
                jLabTipoPagamento.setText("Tipo Pgto:");

                jTexNomeTipoPagto.setEditable(false);
                jTexNomeTipoPagto.setEnabled(false);
                ...
                jPanCondPagLayout.setHorizontalGroup(
                    ...
                    .addGroup(jPanCondPagLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanCondPagLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jTexCdTipoPagto, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
                            .addComponent(jForNumParcelas))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanCondPagLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jTexNomeTipoPagto, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanCondPagLayout.createSequentialGroup()
                                .addGap(10, 10, 10)
                ...
                jPanCondPagLayout.setVerticalGroup(
                    ...
                    .addGroup(jPanCondPagLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanCondPagLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jTexCdTipoPagto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabTipoPagamento)
                            .addComponent(jTexNomeTipoPagto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanCondPagLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel7)
    ...
    private void jTexCdTipoPagtoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTexCdTipoPagtoKeyPressed
        vt = new VerificarTecla();
        if ("F5".equals(vt.VerificarTecla(evt).toUpperCase())) {
            zoomTipoPagamento();
        }
    }//GEN-LAST:event_jTexCdTipoPagtoKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterAtendimentoRev1.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterAtendimentoRev1(su, conexao).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTexCdTipoPagto;
    ...
    private javax.swing.JTextField jTexNomeTipoPagto;
