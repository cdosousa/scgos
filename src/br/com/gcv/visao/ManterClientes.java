...
public class ManterClientes extends javax.swing.JFrame {
     ...
     * @param isBotao Estado dos botões Novo, Editar, Salvar, Cancelar, Exculir
     * e Salvar
     */
    public ManterClientes(SessaoUsuario su, Connection conexao, String sql, boolean isBotao) {
        this.su = su;
    ...
    public ManterClientes(SessaoUsuario su, Connection conexao) {
        this.su = su;
        this.conexao = conexao;
        initComponents();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
    ...
    private void novoRegistro() {
        ...
        liberarCampos();
        jForCdCpfCnpj.setEditable(true);
        jForCdCpfCnpj.setFocusable(true);
        controleBotoes(!ISBOTAO, !ISBOTAO, ISBOTAO, ISBOTAO, !ISBOTAO, !ISBOTAO);
    ...
    // método para dar zoom no campo de CpfCnpj
    ...
    // Método para desabilitar botões direcionais
    private void desabilitaDirecionais(){
        jButProximo.setEnabled(false);
        jButAnterior.setEnabled(false);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterClientes.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterClientes(su, conexao).setVisible(true);
            }
        });
    }
