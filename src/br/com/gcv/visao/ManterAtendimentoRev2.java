 ...
 */
public class ManterAtendimentoRev2 extends javax.swing.JFrame {
    ...
    public ManterAtendimentoRev2(SessaoUsuario su, Connection conexao, ParametrosGerais pg) {
        this.su = su;
    ...
    public ManterAtendimentoRev2(SessaoUsuario su, Connection conexao, ParametrosGerais pg, Contato modcon) {
        this.su = su;
        this.conexao = conexao;
        this.pg = pg;
        formato = NumberFormat.getInstance(Locale.getDefault());
    ...
    private void pesquisarAtendimento() {
        ...
        if (numRegAtend > 0) {
            ...
            if("PG".equals(jComSituacao.getSelectedItem().toString().substring(0, 2).toUpperCase())){
    ...
    private void pesquisarItens() {
        ...
        try {
            ...
            Logger.getLogger(ManterAtendimentoRev2.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (numRegItens > 0) {
    ...
    private void salvarAtendimento(boolean upTela) {
        ...
        if (jTexNomeRazaoSocial.getText().isEmpty() || jComSituacao.getSelectedItem().toString().substring(0, 1) == " ") {
            ...
            modcon.setSituacao(ate.getSituacao());
    ...
    private void initComponents() {
        ...
        jForMetragemArea = new FormatarValor(FormatarValor.NUMERO);
        ...
        setMaximumSize(new java.awt.Dimension(810, 695));
        setMinimumSize(new java.awt.Dimension(810, 695));
        setPreferredSize(new java.awt.Dimension(810, 695));
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterAtendimentoRev2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterAtendimentoRev2(su, conexao, pg).setVisible(true);
            }
        });
    }
