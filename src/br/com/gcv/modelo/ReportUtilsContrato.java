 ...
 * @version 0.01_beta092017
 * @created on 10/04/2018
 */
public class ReportUtilsContrato {
    ...
    public static void sendMail(String titulo, String relatorio, Map parametros, Connection conexao, EnviarEmail email) throws JRException, IOException {
        ...
        String nomeArquivo = "";
        String assunto = "";
        nomeArquivo = String.format("%s%s%s", "Contrato de Prestação de Serviço ", parametros.get("CD_CONTRATO_INI").toString().trim(), ".pdf");
        assunto = String.format("%s%s", "Contrato de Prestação de Serviço ", parametros.get("CD_CONTRATO_INI").toString().trim());
